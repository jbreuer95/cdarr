<nav class="fixed w-full bg-green-600 flex justify-end items-center h-16" >
    ...
    <div class="flex flex-grow justify-end space-x-3 mx-4">
        <a href="/" class="hidden xs:block w-5 h-5 hover:text-gray-700">
        ...
        <a href="/" class="hidden xs:block w-5 h-5 hover:text-gray-700">
            <svg class="hidden xs:block w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
        </a>
    </div>
</nav>
