...
class Debug extends Command
{
    ...
    public function handle()
    {
        ...
        $folder = 'C:\Users\breuer\Videos\Films';
            ...
            foreach ($info->streams as $stream) {
                if ($stream->codec_type === 'video' && ! $video) {
                    ...
                    $video = (object) [
                        ...
                        'duration' => (int) round($stream->duration * 1000),
                    ];
                ...
                if ($stream->codec_type === 'audio') {
                    ...
                    if ($lang !== 'unknown' && $existing = $audio->where('lang', $lang)->first()) {
                    ...
                    $audio->push((object) [
                        ...
                        'bit_rate' => $stream->bit_rate,
                        'duration' => (int) round($stream->duration * 1000 * 1000),
                    ]);
                }
            }
